...
x.101.bootstrapped.LS = rep(0,B)
x.101.bootstrapped.LA = rep(0,B)
for (i in 1:B){
  x.101.bootstrapped.LS[i] = x.101.LS[i] + sample(e.bootstrapped.beta.LS[i,], size = 1)
  x.101.bootstrapped.LA[i] = x.101.LA[i] + sample(e.bootstrapped.beta.LA[i,], size = 1)
}
x.101.LS = x.101.LS + sample(e.observed.LS, size = B, replace = T)
x.101.LA = x.101.LA + sample(e.observed.LA, size = B, replace = T)
```
