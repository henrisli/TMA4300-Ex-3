...
\begin{align*}
P(z_i\leq z) = F_{Z_i}(z_i)&=\begin{cases}\int_0^z \int_0^y \lambda_0e^{-\lambda_0x_i}\lambda_1e^{-\lambda_1y_i}dxdy, &\text{ if }u_i=0\\\int_0^z \int_0^x \lambda_0e^{-\lambda_0x_i}\lambda_1e^{-\lambda_1y_i}dydx, &\text{ if }u_i=1\end{cases}\\
&= \begin{cases}\frac{\lambda_1(\exp\{-z(\lambda_0+\lambda_1)\}-1)}{\lambda_0+\lambda_1}-e^{-\lambda_1z}+1, &\text{ if }u_i=0\\\frac{\lambda_0(\exp\{-z(\lambda_0+\lambda_1)\}-1)}{\lambda_0+\lambda_1}-e^{-\lambda_0z}+1, &\text{ if }u_i=1 \end{cases}
\end{align*}
